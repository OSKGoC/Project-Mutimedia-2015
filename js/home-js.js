...
var loadingMessageMinOpacity = 0.5;   // Minimum opacity of the loading message
var loadingMessageMaxOpacity = 1;     // Maximum opacity of the loading message
var captionSpeed = 500;              // Duration of the caption fade in/out (in ms)
var captionOpacity = 0.95;             // Maximum opacity of the caption when faded in
...
var backgroundSlideOpacity = 1.0;     // Opacity of the slides either side of the current slide
//  --- End Config ---
